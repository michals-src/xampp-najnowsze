...
jQuery( document ).ready(function($) {
    ...
    $( document ).on( 'click', '.customize_multi_add_field', drape_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', drape_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', drape_customize_multi_remove_field )
    ...
    function drape_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            drape_customize_multi_write( $control );
    }

    function drape_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        drape_customize_multi_write( $control );
    }

    function drape_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function drape_customize_multi_write( $element) {
