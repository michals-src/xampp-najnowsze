 ...
 */
Class Drape_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
 ...
 */
Class Drape_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Drape_Dropdown_Chosen_Control extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="drape-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 * @see WP_Customize_Control
 */
Class Drape_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @access public
 */
class Drape_Customize_Section_Upsell extends WP_Customize_Section {
