...
Class Sf_Dashboard{
    ...
    public static function endpoints(){
        ...
        return [
            array( "slug" => "general", "label" => "Ustawienia główne", 'url' => 'ogolne' ),
            array( "slug" => "client_manager", "label" => "Manager klientów", 'url' => 'klienci' ),
            array( "slug" => "exercises", "label" => "Zajęcia", 'url' => 'zajecia' ),
            array( "slug" => "timetable", "label" => "Rozkład zajęć", 'url' => 'rozklad_zajec' ),
