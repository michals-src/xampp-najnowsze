	...
	<div class="mt-5">
		...
		<div class="col-7" >
			...
			<div class="col-md-5" style="padding-top:120px;margin-bottom: -150px;">
				...
				<h1 style="font-size: 4rem;">Profesjonalni instruktorzy</h1>
				<h1 style="font-size: 4rem;">Kameralne grupy fitness</h1>
				<h1 class="mb-3" style="font-size: 4rem;">Miła atmosfera</h1>
...
<section>
	...
	<div class="row no-gutters" style="position:relative;">
		<div style="width:100%;text-align:center;position:absolute;height:100%;z-index:21;">
			<h1 style="color:#fff;margin-top:150px;font-size:4.5rem;text-shadow:0 10px 20px #333;font-weight:800;">Nasza oferta zajęć</h1>
			<h1 style="color:#fff;margin-top:10px;font-size:4.5rem;text-shadow:0 10px 20px #333;font-weight:800;">Zyskaj siłę</h1>
		</div>
