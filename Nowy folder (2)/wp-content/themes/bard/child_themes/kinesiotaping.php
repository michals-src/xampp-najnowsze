<?php 
	/**	
	 * Template name: kinesiotaping
	 */
?>
<?php get_header(); ?>

<header  style="overflow:hidden;margin-top:0;background:url(http://localhost/wp-content/themes/bard/assets/images/16388542_10209494039841262_1271924317_o.jpg) center;">
	...
	<div class="site-container side-margins">
		<div>
			<div class="row no-gutters d-flex align-items-center" style="height:600px;">
				<div class="col-md-12">
					<h1 style="font-size: 3rem;color:#fff;">Wylecz swoje słabości.</h1>
					<h1 style="font-size: 5rem;color:#fff;font-weight:800;">Kinesiotaping</h1>
				</div>
			</div>
		</div>
